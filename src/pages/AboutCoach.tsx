      ...
      <section className="px-6 pt-12 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="overflow-hidden rounded-2xl border border-white/10 bg-zinc-900">
            <img src="/images/coach-rich1.png" alt="Coach 1" className="w-full h-64 object-cover" />
          </div>
          <div className="overflow-hidden rounded-2xl border border-white/10 bg-zinc-900">
            <img src="/images/coach-rich2.png" alt="Coach 2" className="w-full h-64 object-cover" />
          </div>
          <div className="overflow-hidden rounded-2xl border border-white/10 bg-zinc-900">
            <img src="/images/coach-rich3.png" alt="Coach 3" className="w-full h-64 object-cover" />
          </div>
        </div>
      </section>
    </div>
